...
export const BACKEND_URL = "https://YOUR-BACKEND.vercel.app"; // Vercel backend
...
export const DEMO_APIS = [
  ...
  { slug: "gdocs",  name: "Google Docs",   credit_cost: 2, description: "Create and manage Google Docs." },
  ...
  { slug: "pscb",   name: "Secure Viewer", credit_cost: 1, description: "Create a short-lived signed viewer session for a document." },
];
